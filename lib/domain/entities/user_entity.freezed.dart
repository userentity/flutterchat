...
abstract class $UserEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String about, String email, String imageUrl});
}
...
class _$_UserEntity implements _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, name: $name, about: $about, email: $email, imageUrl: $imageUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, about, email, imageUrl);
